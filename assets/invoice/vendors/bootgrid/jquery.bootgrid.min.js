    ...
    */
    ...
    Grid.defaults = {
        ...
        templates: {
            ...
            actions: "<div style=\"display:inline-block\" class=\"{{css.actions}}\"></div>",
            body: "<tbody></tbody>",
            ...
            search: "<div style=\"display:inline-block\" class=\"{{css.search}}\"><div class=\"input-group\"><span class=\"{{css.icon}} input-group-addon glyphicon-search\"></span> <input type=\"text\" class=\"{{css.searchField}}\" placeholder=\"{{lbl.search}}\" /></div></div>",
