...
(function (d) {
    ...
    d.extend(m.prototype, {
        ...
        _fnConstruct: function (a) {
            ...
            if ("function" != typeof this.s.dt.oInstance.fnVersionCheck || !0 !== this.s.dt.oInstance.fnVersionCheck("1.8.0")) alert("FixedColumns " + m.VERSION +
                ...
                var f = "onwheel" in
                    r.createElement("div") ? "wheel.DTFC" : "mousewheel.DTFC";
                ...
                h.on("draw.dt.DTFC", function () {
                    ...
                    d(b.dom.grid.left.liner).off(".DTFC " +
                        f);
            ...
            d.each(this.s.dt.aoColumns, function (e, f) {
                ...
                if (g.filter(":visible").length) {
                    ...
                    a.s.aiOuterWidths.length ===
                        a.s.dt.aoColumns.length - 1 && (h = d(a.s.dt.nTable).css("border-right-width"), i += "string" === typeof h ? 1 : parseInt(h, 10));
        ...
        _fnGridLayout: function () {
            ...
            0 < this.s.iRightColumns && (b.right.wrapper.style.width = h + "px", b.right.wrapper.style.height = "1px", b.right.body.style.height =
        ...
        _fnClone: function (a, b, c, e) {
            ...
            a.body.style.paddingBottom = j.oScroll.iBarWidth +
                "px";
            ...
            if (0 < j.aiDisplay.length) {
                ...
                for (p = 0; p < c.length; p++) l = c[p], o = d(j.aoColumns[l].nTh).clone(!0)[0], o.innerHTML = "", k = o.style, k.paddingTop = "0", k.paddingBottom = "0", k.borderTopWidth = "0", k.borderBottomWidth = "0", k.height = 0, k.width = f.s.aiInnerWidths[l] + "px", h.appendChild(o);
            ...
            b =
                j.oApi._fnGetUniqueThs(j, d(">thead", a.header)[0]);
            d(b).each(function (a) {
                l = c[a];
    ...
    s.Api.register("fixedColumns().relayout()",
        function () {
            return this.iterator("table", function (a) {
