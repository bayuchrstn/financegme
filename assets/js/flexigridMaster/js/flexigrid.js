...
(function ($) {
	...
	$.addFlex = function (t, p) {
		...
		p = $.extend({ //apply default properties
			...
			title: false,
			idProperty: 'id',
			pagestat: 'Menampilkan {from} sampai {to} dari {total} baris data',
			pagetext: 'Halaman',
			outof: 'dari',
			findtext: 'Find',
			params: [], //allow optional parameters to be passed around
			procmsg: 'Sedang memproses, silahkan tunggu ...',
			query: '',
			qtype: '',
			nomsg: 'Data kosong',
		...
		if (p.usepager) {
			...
			$(g.bDiv).after(g.pDiv);
			var html = ' <div class="pGroup"> <div class="pFirst pButton"><i class="material-icons" style="font-size:24px;">&#xE045;</i></div><div class="pPrev pButton"><i class="material-icons" style="font-size:24px;">&#xE037;</i></div> </div> <div class="btnseparator"></div> <div class="pGroup"><span class="pcontrol">' + p.pagetext + ' <input type="text" size="4" value="1" /> ' + p.outof + ' <span> 1 </span></span></div> <div class="btnseparator"></div> <div class="pGroup"> <div class="pNext pButton"><i class="material-icons" style="font-size:24px;">&#xE037;</i></div><div class="pLast pButton"><i class="material-icons" style="font-size:24px;">&#xE044;</i></div> </div> <div class="btnseparator"></div> <div class="pGroup"> <div class="pReload pButton"><i class="material-icons" style="font-size:24px;">&#xE863;</i></div> </div> <div class="btnseparator"></div> <div class="pGroup"><span class="pPageStat"></span></div>';
