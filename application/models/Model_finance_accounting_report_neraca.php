<?php
class Model_finance_accounting_report_neraca extends CI_Model {
		...
		foreach($data as $r){
			if($r['parent'] == $parent){
				...
				if($saldo != 0 && $saldo != 0.00){
					...
					echo '<td align="right"><a href="'.$page_uri.$r['id'].'/'.$searchform.'" target="blank" class="text-primary-800">'.$saldo.'</a></td></tr>';
				}
