<?php
class Model_master_noc_cat_problem_internal extends CI_Model {
	...
	function get_data_table()
	{
		...
		$this->db->group_end();
		$this->db->where('category', 'noc_cat_problem_internal');
	...
	function insert(){
		...
		if($q->num_rows() > 0){
			...
			$data = array( 
						'code' => $code,
						'name' => $name,
						'category' => 'noc_cat_problem_internal',
						'category_name' => 'Kategori Masalah Internal NOC',
					);
