<?php
class Model_customer_visit extends CI_Model {
	...
	function tabs()
	{
        ...
        $arr['selected'] = array(
			...
			'table_columns' => array(
		        ...
		        array('label'   => 'Customer Relationship'),
	...
	function last_task($customer_id)
	{
		$this->db->where('location_id', $customer_id)
			->where('task_category','customer_visit');
		$this->db->order_by('date_created', 'desc');
		$query = $this->db->get('task', 1, 1);
