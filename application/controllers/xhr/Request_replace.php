...
class Request_replace extends MY_Controller {
    ...
    function current($task_id)
    {
        ...
        $data['data_in'] = $this->request_replace->current('in', $task_id);
        $data['data_out'] = $this->request_replace->current('out', $task_id);
        echo $this->load->view('request/request_replace/current/table', $data, TRUE);
    }
