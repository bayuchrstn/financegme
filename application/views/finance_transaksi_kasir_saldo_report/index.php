...
<div style="clear:both; background:#ffffff; width:400px; padding:10px;">
    <form id="pencarian" method="post" target="_blank" action="<?php echo base_url().$this->uri->segment(1).'/print_report'; ?>">
            ...
            <div id="date_closed" style="display:;">
                <label>Date</label> <br />
                <input type="text" class="form-control date_picker" id="searchDateFinish2" name="searchDateFinish2" readonly="readonly" style="width:100px; display:inline;" value="<?php echo date('Y-m-d') ?>"/><br />
            </div>
    <br />
