<script type="text/javascript">
	$(document).ready(function () {
		...
		var oTable = $('#js_table_pre_customer').DataTable({
			...
			"order": [[ 1, "asc" ]],
			"columns": [
				{"data": "urut", "name": "urut", "orderable": false, "searchable": false},
				{"data": "dt_customer_name", "name": "customer_name", "searchable": true},
			...
			// "keys": true,
			"ajax": {
				url: '<?php echo base_url(); ?>pre_customer/data_server',
				type: 'POST'
			},
