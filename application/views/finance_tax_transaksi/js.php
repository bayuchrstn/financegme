<script type="text/javascript">
	...
	function input_data() {
		...
		$('#modal_finance_tax_transaksi_out').modal('show');
		return false;
	}
			...
			success: function(html) {
				if (html != '') {
					$.each(html, function(i, n) {
						$('#id').val(id);
						$('#tipe').val(n["tipe"]);
						$('#tanggal_faktur').val(n["tanggal_faktur"]);
						$('#nama_pkp').val(n["nama_pkp"]);
						$('#no_seri_faktur').val(n["no_seri_faktur"]);
						$('#deskripsi').val(n["deskripsi"]);
						$('#tax_type').val(n["tax_type"]);
						$('#cabang').val(n["cabang"]);
						$('#msa').val(n["msa"]);
						$('#jumlah').val(n["jumlah"]);
