<?php
	...
	$options['modal_id'] = 'modal_finance_tax_transaksi_out';
	$options['modal_size'] = 'modal-default';
	//$options['modal_icon'] = $this->theme->icon('finance_tax_transaksi_out');
	...
	$options['form_action'] = '';
	$options['main_content'] = $this->load->view('finance_tax_transaksi/form_grid', $data, TRUE);
