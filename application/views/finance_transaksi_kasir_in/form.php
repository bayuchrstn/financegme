<?php
	...
	$options['modal_id'] = 'modal_finance_transaksi_kasir_in';
	$options['modal_size'] = 'modal-default';
	//$options['modal_icon'] = $this->theme->icon('finance_transaksi_kasir_in');
	...
	$options['form_action'] = '';
	$options['main_content'] = $this->load->view('finance_transaksi_kasir_in/form_grid', $data, TRUE);
