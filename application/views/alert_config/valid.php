<script type="text/javascript">
	$(document).ready(function(){
		$("#modal_alert_config_form").validate({
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    type : 'POST',
                    url  : $('#modal_alert_config_form').attr('action'),
                    data  : $('#modal_alert_config_form').serialize(),
                    success : function(res){
						...
						$('.modal').modal('hide');
						$('#js_table_alert_config').DataTable().ajax.reload( null, false );
                    },
