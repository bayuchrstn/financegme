					...
					<table class="table i-table m-t-10 m-b-10">
						<tbody><b>
								<tr class="t-uppercase">
									...
									<td rowspan="2" class="navytd" style="text-align:center;vertical-align:middle;color:white;border-left: 1px solid white;font-weight: bold;">TOTAL PRICE</td>
								</tr>
								<tr class="t-uppercase">
										...
										if ((!empty($get_lain)) and ($sum_lain2->jml == $sum_lain->total)) {
											foreach ($get_lain as $rowln) {
												...
												echo '<tr>
														...
														<td style="border-left: 1px solid black;"> </td>
														<td style="text-align:center;border-left: 1px solid black;">Rp ' . $this->Kamus_model->uang($rowln->biaya) . '</td>
												</tr>';
											}
										} else {
											$cou = $cou + 1;
