						...
						<div class="row" id="date_merge">
							<div class="col-sm-6">
								...
								<div class="input-group form-group">
									<span class="input-group-addon"><i class="zmdi zmdi-link"></i></span>
										...
										<input name="id_nominal" type="hidden" id="id_nominal">
							...
							<div class="col-sm-6">
								...
								<div class="input-group form-group">
									<span class="input-group-addon"><i class="zmdi zmdi-money"></i></span>
										<div class="dtp-container fg-line">
										<?php 
											echo form_dropdown('akun_d', $akunall_id, '', 'class="tag-select" id="coa"');
										?>
									</div>
								</div>
							</div>
							<div class="col-sm-6">
								...
								<div class="input-group form-group">
									<span class="input-group-addon"><i class="zmdi zmdi-money"></i></span>
										<div class="dtp-container fg-line">
										<input name="nominal" readonly type="number" id="kekurangan" class="form-control">
									</div>
								</div>
							</div>
							<div class="col-sm-6">
