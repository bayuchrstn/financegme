								...
								<div class="row">
									...
									<div class="col-sm-3">
										...
										<div class="input-group">
											...
											<div class="fg-line">
												<input type='text' name="tanggal" id="tanggal" class="form-control date-picker" placeholder="Tentukan Tanggal"  value="<?php echo date('Y-m-d'); ?>">
									...
									<div class="col-sm-3">
										...
										<div class="input-group">
											...
											<div class="fg-line">
												<?php
													echo form_dropdown('payment_type', array('1'=>'Transfer','2'=>'Cash','3'=>'BG','4'=>'Lain-lain'), '', 'class="tag-select"');
												?>
											</div>
										</div>
									</div>
									<div class="col-sm-3">
										...
										<div class="input-group form-group">
											<span class="input-group-addon"><i class="zmdi zmdi-money"></i></span>
												...
												<?php 
													echo form_dropdown('rek', $opt_bank, '', 'class="tag-select"');
												?>
											</div>
										</div>
									</div>
									<div class="col-sm-12">
										...
										<div class="input-group">
											...
											<div class="col-sm-12">
												<div class="fg-line">    
													<input name="note" type="text" class="form-control" value="<?php echo isset($edit->baa)?$edit->note:'';?>"></input>
												</div>
											</div>
										</div>
									</div>
										...
										<div class="row">
											<div class="col-sm-3">
												...
												<div class="input-group">
													<span class="input-group-addon"><i class="zmdi zmdi-money-box"></i></span>
													<div class="fg-line">
														<input type="text" id="b_admin" name="b_admin" class="rupiah form-control trig_angka_fin">
													</div>
												</div>
											</div>
											<div class="col-sm-offset-1 col-sm-3">
		...
		$(document).ready(function(){
				...
				$.ajax({
					...
					success:function(result){
						...
						// $('#id_inv').change(function(){
							...
							var dat={'nota':inv,'biaya_extra':$('#biaya_extra_fin').val()};
							$.ajax({
								...
								success:function(result){
									...
									$(".trig_nominal, .trig_nominal_ppn, .trig_bayar").keyup(function() {
										...
										var kekurangan = parseFloat(kurang) - parseFloat(byr) - parseFloat(byr_voucher);	
			...
			function update_pembayaran(){
				...
				$(".trig_angka_fin").bind("keyup change click",function(){
					...
					var grand = 0;
					grand = parseFloat(sub_tot) - parseFloat(tot) - parseFloat(pphnp);
					$('#grand').val(grand);
				});			
			}
			update_pembayaran();
