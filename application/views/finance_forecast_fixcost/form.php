<?php
	...
	$options['modal_id'] = 'modal_finance_forecast_fixcost_out';
	$options['modal_size'] = 'modal-default';
	//$options['modal_icon'] = $this->theme->icon('finance_forecast_fixcost_out');
	...
	$options['form_action'] = '';
	$options['main_content'] = $this->load->view('finance_forecast_fixcost/form_grid', $data, TRUE);
