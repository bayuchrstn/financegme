...
<head>
    ...
    <style type="text/css">
        .tabel_report_invoice th,
        .tabel_report_invoice td {
            padding: 7px 10px;
        }
                            ...
                            <tr style="font-weight:bold;">
                                <td valign="top" align="right" style="border:0; padding:3px 5px;" colspan="4">
                                    <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;" width="100%">
                                        <tr>
                                            <td width="1" style="white-space:nowrap; border:0; padding:0; padding-top:50px; padding-bottom:20px;" valign="top">Terbilang / In words :</td>
                                            <td style="border:0; text-transform:capitalize; font-style:italic; font-weight:normal; padding:0; padding-left:10px; padding-top:50px; padding-bottom:20px;"><?php echo kata_terbilang($total); ?> rupiah</td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                            ...
                            ?>
                                ...
                                <tr style="font-weight:bold;">
                                    <td valign="top" style="border:0; padding:3px 5px;" colspan="4">
                                        <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;" width="100%">
                                            <tr>
                                                <td width="50%" style="padding:0; padding-bottom:10px; border:0;padding-left: 640px;" align="center">Approved by<br /><br /><br /><br /><br /><br /><br /><?php echo $by_approve; ?><br /> ( Operational Director ) <br /> www.Gmedia.co.id</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
