    ...
    <div class="invoice">
        <div>
            <div style="width:50%;display:inline-block;">
                <h1 style="margin-left:20px;margin-bottom:0px;height:60px"><img class="i-logo" style="height:60px;" alt="" src="./assets/invoice/img/boxes2.png">
                </h1>
            </div>
