	...
	function update(id)
    {
        ...
        $.ajax({
            ...
            success: function(res) {
				...
				getajax('<?php echo base_url(); ?>xhr/approval/index/po/'+response.id, 'approval_div_update');

				getajax('<?php echo base_url(); ?>po_approval/show/'+response.id+'/echo', 'detail_po_div_update');
