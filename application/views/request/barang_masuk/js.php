<script type="text/javascript">
    ...
    function update(id)
    {
        ...
        $.ajax({
            ...
            success: function(res) {
				...
				$('#form_barang_masuk_update').attr('action', '<?php echo base_url(); ?>ajax/save_barang_masuk');
	...
	{
		$('#approval_form_update').load('<?php echo base_url(); ?>ajax/item_in_approval/'+task_id);
	}
