        ...
        $('#attachment_insert').fileupload({
            ...
            start: function (e, data) {
				...
				$.each(data.result.attachment, function (index, file) {
					...
					$('#attachment_ul_insert').append('<li id="attachment_li_'+i+'" class="alert alert-primary no-border mb-5">'+file.name+' <a onclick="remove_this_attachment('+i+');" href="#" class="pull-right"><i class="icon-trash position-left"></i>Remove<input type="hidden" name="attachment[]" value="'+file.name+'"></a></li>');
