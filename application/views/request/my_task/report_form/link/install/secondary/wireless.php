<?php
    $prefix  = $ps;
    $default_value = array();
    $wr_survey = $this->ui->forms_by_section('task_report', 'wr_install_secondary', $default_value, $prefix);
...
<div class="row">
    ...
    <div class="col-lg-6">
        <?php echo $wr_survey['wireless_jarak_secondary']; ?>
    </div>
</div>

<div class="row">
    <div class="col-lg-6">
        <?php echo $wr_survey['wireless_signal_strenght_secondary']; ?>
    </div>
    <div class="col-lg-6">
        <?php echo $wr_survey['wireless_kualitas_signal_secondary']; ?>
    </div>
</div>

<div class="row">
    <div class="col-lg-6">
        <?php echo $wr_survey['wireless_antena_secondary']; ?>
    </div>
    <div class="col-lg-6">
        <?php echo $wr_survey['wireless_radio_secondary']; ?>
    </div>
</div>
<div class="row">
    <div class="col-lg-6">
        <?php echo $wr_survey['wireless_jenis_kabel_secondary']; ?>
    </div>
    <div class="col-lg-6">
        <?php echo $wr_survey['wireless_jarak_kabel_secondary']; ?>
    </div>
</div>
