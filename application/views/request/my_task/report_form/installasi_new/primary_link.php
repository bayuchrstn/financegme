<?php
	...
	$selected_jenis_primary_link = ( isset($report_detail['primary_link_type']) ) ? $report_detail['primary_link_type'] : 'wr';
...
<script type="text/javascript">
	$(document).ready(function(){
		set_option('<?php echo base_url(); ?>select_option/request/my_task/jenis_primary_link_install', 'primary_link_type_primary_link', '<?php echo $selected_jenis_primary_link; ?>');
	...
	function change_link_type(jenis_link)
	{
		$.ajax({
			...
			url: '<?php echo base_url(); ?>xhr/task_report/link_type_picker/install/primary/'+jenis_link+'/<?php echo $rid; ?>',
