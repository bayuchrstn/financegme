<form id="form_installasi_report" action="<?php echo base_url(); ?>xhr/task_report/create/<?php echo $task_id; ?>" method="post">
...
<?php
	...
	$is_progress = $task_detail['status']=='progress' ? '' : 'ts_laporan_barang_keluar';
...
<script type="text/javascript">
	...
	// 	var xx = tinymce.get('body_report_form').getContent();

	// 	if(xx !=''){
	// 		var yy = xx;
	// 	} else {
	// 		var yy = report_detail.body;
	// 	}

	// 	tinymce.get('body_report_form').setContent(yy);
	// 	$('#body_fake_report_form').val(yy);
	// });
