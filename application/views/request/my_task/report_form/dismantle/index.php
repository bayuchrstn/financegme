<form id="form_dismantle_report" action="<?php echo base_url(); ?>xhr/task_report/create/<?php echo $task_id; ?>" method="post">
...
<?php
	...
	$is_progress = $task_detail['status']=='progress' ? '' : 'ts_laporan_barang_kembali';
...
<script type="text/javascript">
	...
	getajax('<?php echo base_url(); ?>xhr/task_item/index/task_item_in/'+task_detail.id+'/laporan_teknis/barang_keluar_list/ts_laporan_barang_kembali', 'daftar_barang_kembali');
