...
<script type="text/javascript">
	...
	set_option('<?php echo base_url(); ?>select_option/request/barang_replace/approval_status', 'status_<?php echo $prefix; ?>', 'approved');
	$('#id_<?php echo $prefix; ?>').val('<?php echo $task_id; ?>');
	//
