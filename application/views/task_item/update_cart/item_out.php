...
<script type="text/javascript">
	...
	$('#note_<?php echo $prefix; ?>').val(detail.options.note);
	$('#rowid_<?php echo $prefix; ?>').val(detail.rowid);
	set_option('<?php echo base_url(); ?>select_option/request/request_replace/status_kepemilikan', 'status_kepemilikan_<?php echo $prefix; ?>', detail.options.status_kepemilikan);
