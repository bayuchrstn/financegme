...
<!-- Modal Tambah Data -->
<div id="modal_finance_history" class="modal" data-backdrop="static" data-keyboard="false" style="display: none;">
        ...
        <div class="modal-content">
            <div class="modal-header ">
                ...
                <h4 class="modal-title">
                    ...
                    <span id="modal_title_custom"><span class=" icon-box"></span> History Down Payment</span>
                </h4>
            </div>
            <div class="modal-body">
                <table id="histodp" class="table-bordered" width="100%">
                </table>
            </div>
